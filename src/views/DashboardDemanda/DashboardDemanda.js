...
class DashboardDemanda extends Component {
	...
	render () {
		...
		let dashboard = (<Row>
				...
				<Col xs="6" sm="6">
					...
					{this.state.horario_ponta !== undefined && this.state.horario_ponta !== null &&
...
export default DashboardDemanda;
