...
- refactor(Relatorios): tweak lazy and Suspense for Widget03 
...
- feat(Relatorios): new `Suspense` example with Widget03
...
##### `v2.0.0-alpha.3`
- refactor(Certidoes): view layout, minor temp tweaks
...
- refactor: Relatorios legend badge pill
...
###### `v1.0.8`
- refactor: Relatorios radio buttons, new `onRadioBtnClick()` method
...
- Relatorios .dropdown-menu-right temp.scss hotfix (full)
- callout.scss .chart-wrapper hotfix (full)

###### `2017.08.11`
- Bootstrap 4 beta
- Relatorios component (full):
